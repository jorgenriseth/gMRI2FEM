#!/bin/bash
# Taken from mri2fem-book
# by Mardal, Rognes, Thompson, Valnes
# https://raw.githubusercontent.com/kent-and/mri2fem/master/mri2fem/mri2fem/chp4/extract-ventricles.sh
